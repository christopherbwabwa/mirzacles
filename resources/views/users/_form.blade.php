...
<div class="row mb-3">
    ...
    <div class="col-md-6">
            ...
            <input type="radio" name="prefixname" id="Mr" value="Mr" checked/>
            <label for="Mr">Mr</label>
    
            <input type="radio" name="prefixname" id="Mrs" value="Mrs"/>
            <label for="Mrs">Mrs</label>
    
            <input type="radio" name="prefixname" id="Ms" value="Ms"/>
...
<div class="row mb-3">
    <label for="suffixname" class="col-md-4 col-form-label text-md-end">{{ __('Suffixname') }}</label>

    <div class="col-md-6">
        <input id="suffixname" type="text" class="form-control @error('suffixname') is-invalid @enderror"
            name="suffixname" value="{{ old('suffixname') }}" autocomplete="suffixname" autofocus>
